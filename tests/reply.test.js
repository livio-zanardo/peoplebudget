        ...
        request(app)
            ...
            .then(({ body, statusCode }) => {
                ...
                expect(body.response).toStrictEqual(
                    testJsonDataResponsePagination
                );
                done();
            });
    });
        ...
        request(app)
            ...
            .then(({ body, statusCode }) => {
                ...
                expect(body.response).toBe(
                    `reply with id[${testDBEntryId}] updated`
                );
                done();
            });
    });
    ...
    it("Can Delete A Reply", async (done) => {
        request(app)
            ...
            .then(({ body, statusCode }) => {
                ...
                expect(body).toHaveProperty("response");
                expect(body.response).toBe(
                    `reply with id[${testDBEntryId}] deleted`
                );
                done();
            });
    });
